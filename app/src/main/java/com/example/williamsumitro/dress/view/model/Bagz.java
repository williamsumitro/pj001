...
public class Bagz {
    ...
    public Bagz(String namatoko, String namaproduk, int gambarproduk, int hargaproduk, int qtyS, int qtyM, int qtyL, int qtyXL, int qtySubtotal, int persen, int discount, int hargaSubtotal, int totalharga, int hargaS, int hargaM, int hargaL, int hargaXL){
    ...
    public Bagz(String namatoko, String namaproduk, int gambarproduk, int hargaproduk, int qtyS, int qtyM, int qtyL,
