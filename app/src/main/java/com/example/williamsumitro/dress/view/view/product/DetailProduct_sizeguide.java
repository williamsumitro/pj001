...
public class DetailProduct_sizeguide extends AppCompatActivity {
    @BindView(R.id.detailproductsize_tvsleevelengthxs) TextView sleevelengthXS;
    ...
    @BindView(R.id.detailproductsize_tvshoulderxs) TextView shoulderXS;
    ...
    @BindView(R.id.detailproductsize_tvlengthxs) TextView lengthXS;
    ...
    @BindView(R.id.detailproductsize_tvcuffxs) TextView cuffXS;
    ...
    @BindView(R.id.detailproductsize_tvbustxs) TextView bustXS;
    ...
    @BindView(R.id.detailproductsize_tvbiceptlengthxs) TextView biceptlengthXS;
